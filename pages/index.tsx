...
export default function Home() {
    ...
    const [writeProject, setWriteProject] = useState<Array<NativeStakeClient | null>>([]);
    const [getProject, setGetProject] = useState<Array<NativeStakeQueryClient | null>>([]);
        ...
        <MainLayoutLayout>
            <Container maxW="5xl" py={10}>
                ...
                {listProjects.length > 0 &&
                    address &&
                    listProjects.map((el, index) => <div key={el.contract} id={index} style={{margin: "1rem"}}><Card
