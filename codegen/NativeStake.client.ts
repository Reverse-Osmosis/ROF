...
import { AllAccountsResponse, Uint128, Expiration, Timestamp, Uint64, AllAllowancesResponse, AllowanceInfo, AllowanceResponse, BalanceResponse, ClaimsResponse, Claim, ExecuteMsg, Duration, Addr, GetConfigResponse, GetHooksResponse, InstantiateMsg, ListStakersResponse, StakerBalanceResponse, QueryMsg, StakedBalanceAtHeightResponse, StakedValueResponse, TokenInfoResponse, TotalStakedAtHeightResponse, TotalValueResponse } from "./NativeStake.types";
export interface NativeStakeReadOnlyInterface {
...
export class NativeStakeQueryClient implements NativeStakeReadOnlyInterface {
...
export interface NativeStakeInterface extends NativeStakeReadOnlyInterface {
  contractAddress: string;
  sender: string;
...
export class NativeStakeClient extends NativeStakeQueryClient implements NativeStakeInterface {
